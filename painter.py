...
while True:
        ...
        if (my_fingers[1] and my_fingers[2]):
            ...
            if (y1 < 125):
                if (90 < x1 < 180):
                    ...
                    draw_color = (0, 234, 255)
                elif (696 < x1 < 786):
                    default_overlay = overlay_image[3]
                    draw_color = (0, 255, 0)
                elif (898 < x1 < 988):
                    default_overlay = overlay_image[4]
                    draw_color = (255, 150, 0)
                elif (1100 < x1 < 1190):
                    default_overlay = overlay_image[5]
                    draw_color = (255, 0, 255)

            cv2.putText(frame, 'Color Selector Mode', (900, 680), fontFace=cv2.FONT_HERSHEY_COMPLEX,
    ...
    cv2.putText(frame, 'Client FPS:' + str(int(fps)), (10, 670), fontFace=cv2.FONT_HERSHEY_SIMPLEX, fontScale=1,
